...
#define MAX_RPT_SIZE 1024
#define MAX_MISS_QSIZE 4096

enum RPT_State {INIT, TRANSIENT, STEADY, NOPRED};
typedef enum RPT_State RPT_State;

static inline const char *stringFromRPT_States (RPT_State state) {
    static const char *strings [] = {"INIT", "TRANSIENT", "STEADY", "NOPRED"};
...
typedef struct rpt_entry rpt_entry;
